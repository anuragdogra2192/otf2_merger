...
pre_flush([[maybe_unused]] void* userData, [[maybe_unused]] OTF2_FileType fileType,
          [[maybe_unused]] OTF2_LocationRef location, [[maybe_unused]] void* callerData,
...
post_flush([[maybe_unused]] void* userData, [[maybe_unused]] OTF2_FileType fileType,
...
int main(int argc, char** argv) {
  ...
  OTF2_Archive* archive = OTF2_Archive_Open(
    args.m_archive_path.c_str(), args.m_archive_name.c_str(), OTF2_FILEMODE_WRITE,
    CHUNK_SIZE_EVENTS, CHUNK_SIZE_DEFS, file_substrate, compression);
